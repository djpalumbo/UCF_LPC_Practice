...
public class microwave 
{
   ...
   public static String   FILE_NAME = "microwave.in";
   ...
   public microwave() throws FileNotFoundException 
   {
      ...
      // Repeatedly handle each case
      for (curTestCase = 1; curTestCase <= numTestCases; curTestCase++)
      {
         ...
         // Output the results of the current case
         System.out.printf("Case #%d: %d%n", curTestCase, bestPress);
      }
   }
